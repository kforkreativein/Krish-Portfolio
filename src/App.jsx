  ...
  useEffect(() => {
    ...
    styleEl.textContent = `
      ...
      :root {
        ...
        --pad-process-t: ${settings?.pad_process_t_mob || '65px'};
        --pad-process-b: ${settings?.pad_process_b_mob || '65px'};
        --pad-clients-t: ${settings?.pad_clients_t_mob || '60px'};
        --pad-clients-b: ${settings?.pad_clients_b_mob || '60px'};
        --pad-stack-t: ${settings?.pad_stack_t_mob || '45px'};
        ...
        --pad-testimonials-t: ${settings?.pad_testimonials_t_mob || '65px'};
        ...
        --pad-project-t: ${settings?.pad_project_t_mob || '60px'};
      ...
      @media (min-width: 768px) {
        :root {
          ...
          --pad-different-t: ${settings?.pad_different_t_tab || '100px'};
          ...
          --pad-process-t: ${settings?.pad_process_t_tab || '80px'};
          --pad-process-b: ${settings?.pad_process_b_tab || '80px'};
          --pad-clients-t: ${settings?.pad_clients_t_tab || '65px'};
          --pad-clients-b: ${settings?.pad_clients_b_tab || '65px'};
          --pad-stack-t: ${settings?.pad_stack_t_tab || '55px'};
          ...
          --pad-testimonials-t: ${settings?.pad_testimonials_t_tab || '80px'};
          --pad-testimonials-b: ${settings?.pad_testimonials_b_tab || '80px'};
          --pad-cta-t: ${settings?.pad_cta_t_tab || '100px'};
          --pad-cta-b: ${settings?.pad_cta_b_tab || '100px'};
          --pad-project-t: ${settings?.pad_project_t_tab || '80px'};
      ...
      @media (min-width: 1024px) {
        :root {
          ...
          --pad-different-t: ${settings?.pad_different_t_desk || '115px'};
          ...
          --pad-work-t: ${settings?.pad_work_t_desk || '110px'};
          ...
          --pad-clients-t: ${settings?.pad_clients_t_desk || '80px'};
          --pad-clients-b: ${settings?.pad_clients_b_desk || '80px'};
          --pad-stack-t: ${settings?.pad_stack_t_desk || '85px'};
          ...
          --pad-testimonials-t: ${settings?.pad_testimonials_t_desk || '100px'};
          ...
          --pad-project-t: ${settings?.pad_project_t_desk || '80px'};
